...
$(function ($) {
	...
	// appear blog overly on hover
	$(".contact .blog .blog-img img").hover(function() {
	
		$(".contact .blog .blog-img .blog-overlay").slideDown(500);
	
	}, function () {
	
		$(".contact .blog .blog-img .blog-overlay").slideUp(500);
